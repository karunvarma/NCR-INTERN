...
int main()
{
	...
	//3.	Write a program to create a child process
	...
	cout << "current thread id " << GetCurrentThreadId() << endl << endl;

	cout << "get process id " << GetProcessId(GetCurrentProcess()) << endl;
	cout << "get process id of thread " << GetProcessIdOfThread(GetCurrentThread()) << endl;
	cout << "get thread id " << GetThreadId(GetCurrentThread()) << endl;
